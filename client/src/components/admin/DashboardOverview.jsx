...
export const DashboardOverview = ({ projects = [], leads = [], services, setLeads }) => {
  ...
  const handleLeadStatusChange = async (id, status) => {
    try {
      const response = await axios.put("/api/leads/" + id, { status })
                            ...
                            <tr key={lead._id} className="border-b">
                              ...
                              <td>
                                <select
                                  ...
                                  className="border-2 border-primary/20 bg-muted/50 rounded-md px-2 py-1 focus:border-primary focus:outline-none transition-colors"
                                >
                                  {
